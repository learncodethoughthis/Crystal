...
public class RequesterFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        RequesterViewModel requesterViewModel =
                new ViewModelProvider(this).get(RequesterViewModel.class);

        binding = FragmentRequesterBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        final TextView textView = binding.textDashboard;
        requesterViewModel.getText().observe(getViewLifecycleOwner(), textView::setText);
        return root;
    }
